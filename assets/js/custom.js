...
function fnEnviarMail()
{
	...
	{
		$('#resultado').fadeOut(0);
		$('#resultado').html("Todos los datos son requeridos. Por favor complételos e intente nuevamente.");
	...
	else
	{
		$.ajax({
				...
				beforeSend: function () {
						...
						$('#resultado').fadeOut(0);
						$("#resultado").html("Enviando mensaje, aguarde por favor...");
						$('#resultado').removeClass('alert-success');
